...
from gen_agent.cognitive import (
    make_hrm_if_enabled, make_rlif_if_enabled,
    make_seal_if_enabled, make_social_learner_if_enabled,
)
...
# Advanced memory
from gen_agent.memory.graph import KnowledgeGraph, GraphRAGRetriever
kg = KnowledgeGraph()
...
from gen_agent.memory.privacy import classify, MaRSEngine
